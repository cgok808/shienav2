...
const Footer = () => {
  return (
    <footer className='bg-[#96676C] pt-16 pb-16 flex flex-col lg:flex-row lg:text-left text-center items-center justify-center text-qWhite'>
      <div className='lg:w-[30%]'>
        <div className="mb-3 lg:mb-0">
          <h1 className="font-extrabold text-3xl">contact</h1>
          <ul>
            <li>email: shishishiena@gmail.com</li>
            <li>twitter: @shishishiena</li>
            <li>discord: @shiena#077</li>
          </ul>
        </div>
      </div>
      <div className='lg:w-[30%]'>
