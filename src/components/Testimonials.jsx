    ...
    <section className='bg-[#f6e8de]' id='reviews'>
      ...
      <div className='mt-12 mb-12 flex flex-col items-center '>
        <div className='h-80 w-1/2 bg-[#664A58] rounded-2xl flex justify-center items-center '>
          <BsArrowLeftSquareFill className='text-[#664A58] w-16 h-16 relative right-20 md:right-24 lg:right-28 transition__ease hover:scale-110 active:scale-90' />
          ...
          <BsArrowRightSquareFill className='text-[#664A58] w-16 h-16 relative left-20 md:left-24 lg:left-28 transition__ease hover:scale-110 active:scale-90' />
        </div>
